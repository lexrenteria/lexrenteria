...
const FooterSection = () => {
  ...
  const socials = [
    { label: "Instagram", href: "https://instagram.com/lexrenteria", icon: <Instagram className="w-6 h-6" /> },
    { label: "X", href: "https://x.com/lexrenteria", icon: <XIcon /> },
    { label: "Facebook", href: "https://facebook.com/lexrenteria", icon: <Facebook className="w-6 h-6" /> },
  ...
  return (
    <footer id="contact" className="border-t border-border py-24 px-6" aria-label="Contact">
      <div className="max-w-4xl mx-auto flex flex-col items-center gap-10">
        ...
        {/* Email — large elegant serif */}
        <a
          href={mailto}
          className="font-heading text-2xl sm:text-3xl md:text-4xl italic text-foreground hover:text-primary transition-colors duration-300"
          aria-label="Email"
        >
          {display}
        </a>
